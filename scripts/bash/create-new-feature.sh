...
TEMPLATE="$REPO_ROOT/.forge/templates/spec-template.md"
SPEC_FILE="$FEATURE_DIR/spec.md"
if [ -f "$TEMPLATE" ]; then cp "$TEMPLATE" "$SPEC_FILE"; else touch "$SPEC_FILE"; fi

# Set the FORGE_FEATURE environment variable for the current session
export FORGE_FEATURE="$BRANCH_NAME"
...
if $JSON_MODE; then
    ...
    echo "FORGE_FEATURE environment variable set to: $BRANCH_NAME"
fi
